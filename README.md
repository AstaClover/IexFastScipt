# iex Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a iex Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)
...
`wget -N https://raw.githubusercontent.com/AstaClover/iex/master/install.sh`
***
...
***Step 1***
* Download and install the iex wallet [here](https://iex.to/)
***

***Step 2***
* Send EXACLY **10,000** iex to a receive address within your wallet.
***
